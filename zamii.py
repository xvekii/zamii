...
class BazaToplevelWindow(customtkinter.CTkToplevel):
  def __init__(self):
    ...
    self.radno_mjesto_label.grid(row=1, column=2, padx=10, pady=10)

    self.radno_mjesto_entry = Entry(self.podatci_frame, width=3)
    self.radno_mjesto_entry.grid(row=1, column=3, padx=10, pady=10)
    
    self.prezime_label = Label(self.podatci_frame, text="Prezime")
    self.prezime_label.grid(row=1, column=4, padx=10, pady=10)
    
    self.prezime_entry = Entry(self.podatci_frame, width=20)
    self.prezime_entry.grid(row=1, column=5, padx=10, pady=10)
    
    self.ime_label = Label(self.podatci_frame, text="Ime")
    self.ime_label.grid(row=1, column=6, padx=10, pady=10)
    
    self.ime_entry = Entry(self.podatci_frame, width=15)
    self.ime_entry.grid(row=1, column=7, padx=15, pady=10)
